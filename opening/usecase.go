...
type OpeningUsecase interface {
	...
	UpdateOpening(opening *schemas.Opening, request *UpdateOpeningRequest) error
...
func (u *OpeningUsecaseImpl) UpdateOpening(opening *schemas.Opening, request *UpdateOpeningRequest) error {
