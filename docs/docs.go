...
const docTemplate = `{
        ...
        "/opening": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "ID query parameter is missing",
                        "schema": {
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.UploadResumeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
    ...
    "definitions": {
        ...
        "handler.UploadResumeResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/schemas.ResumeResponse"
                    }
                },
                "message": {
                    "type": "string"
